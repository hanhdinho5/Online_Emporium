                ...
                <div class="section" id="list-product-wp">
                    @if ($list_product->count() > 0)
                        <div class="section-head clearfix">
                            <h3 class="section-title fl-left">{{ $cat_active }}</h3>
                    ...
                    <div class="section-detail">
                        <ul class="list-item clearfix flex-product">
                            ...
                            @empty
                                <div id="wp-seach-product" class="text-center w-100">
                                    <img style="border-radius: 100%;width: 37%;margin: 1em auto; opacity:80%"
                                        src="{{ asset('client.css/images/seach_error.jpg') }}" alt="">
                                    <strong class="font-italic">Không tồn tại sản phẩm nào trong danh mục!</strong>
                                </div>
                            @endforelse
