                        ...
                        <div class="info fl-right">
                            ...
                            <form action="{{ route('cart.add', $product_detail->id) }}" method="post">
                                ...
                                <div id="num-order-wp">
                                    ...
                                    <input type="text" class="qty_detail_product" name="num-order" value="1"
                                        id="num-order">
                                    <a title="" id="plus"><i class="fa fa-plus"></i></a>
                                    {{-- <input type="number" value="1" min="1" max="10"> --}}
                                </div>
                                <button data-id="{{ $product_detail->id }}" type="submit"
                                    class="btn btn-success add_product">Thêm giỏ hàng</button>
                            </form>
                        </div>
                    </div>
                </div>
