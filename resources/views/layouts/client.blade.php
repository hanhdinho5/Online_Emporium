                ...
                <div id="head-body" class="clearfix">
                    <div class="wp-inner">
                        <a href="{{ route('client.home') }}" title="" id="logo" class="fl-left"><img
                                style="height:66px; width:auto; filter: brightness(220%)"
                                src="{{ asset('client.css/images/logo.png') }}" /></a>
                        ...
                        <div id="action-wp" class="fl-right">
                            <a href="{{ route('contact') }}" id="advisory-wp" class="fl-left text-white">
                                ...
                                <span class="phone">0357.158.197</span>
                                <a>
                ...
                $(".num-order").change(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('span#num').text(data.count == 0 ? '' : data.count);
