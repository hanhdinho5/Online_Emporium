                        ...
                        <div class="card-body">
                            <div class="row">
                                @foreach ($permission as $item)
                                    <div class="col-md-3">
                                        {{-- <input type="checkbox" class="permission" value="{{$item->slug}}" name="permission_id[]" id="{{$item->slug}}">
                                        <label for="{{$item->slug}}">{{$item->name}}</label> --}}
                                        {!! Form::checkbox('permission_id[]', $item->id, null, ['class' => 'permission', 'id' => $item->slug]) !!}
